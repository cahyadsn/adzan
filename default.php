...
purpose	: 
create	: 2006/02/01
last edit	: 2006/03/01;2006/03/17,070430
author	: cahya dsn
================================================================================
...
<head>
<title>Adzan ver <?php echo $Adzan->cfgArray['version'];?></title>
...
<body>
<?php 
$Adzan->generate_data($Adzan->cfgArray['period'],$d,$m,$y,$Adzan->cfgTime);
?>
</body>
</html>